    ...
    <div className="App">
      <div className="calculator">
        ...
        <div className="operators">
          ...
          <button type="button" className="ope Multiply">x</button>
          <button type="button" className="ope Minus">-</button>
          <button type="button" className="ope Plus">+</button>
          <button type="button" className="ope Equal">=</button>
        </div>

        <div className="digits">
          <button type="button" className="delete delete">AC</button>
