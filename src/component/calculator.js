    ...
    <div className="Calc">
      ...
      <div className="calculator">
        <div className="display">
          <div className="display-screen" type="text">{result.next || result.total || '0'}</div>
        </div>

        <div className="operators">
          <button type="button" onClick={() => { handleClick('÷'); }} className="ope Divide">÷</button>
          <button type="button" onClick={() => { handleClick('x'); }} className="ope Multiply">x</button>
          <button type="button" onClick={() => { handleClick('-'); }} className="ope Minus">-</button>
          <button type="button" onClick={() => { handleClick('+'); }} className="ope Plus">+</button>
          <button type="button" onClick={() => { handleClick('='); }} className="ope Equal">=</button>
        </div>

        <div className="digits">
          <button type="button" onClick={() => { handleClick('AC'); }} className="delete delete">AC</button>
          <button type="button" onClick={() => { handleClick('+/-'); }} className="delete clear">+/-</button>
